# Weekly Thesis & Chokepoint Brief — 2026-07-25
...
**Inputs（可选引用）**
- Daily digests: `reports/digest/2026-07-21` … `2026-07-25`
...
| 字段 | 本周结论 |
|---|---|
| **Overall thesis** | Intact / Watch / Damaged —  |
| **Posture** | Hold thesis / Deepen research / Reduce conviction / Re-underwrite |
| **Biggest fact this week** |  |
| **Biggest risk this week** |  |
| **Portfolio logic impact** | None / Selective / Broad —  |
| **Next falsifier to watch** |  |

**一句话周记：** Fill executive strip and chokepoint dashboard from this week’s digests.
...
**相对上周变化：** Unchanged / Improved / Deteriorated — Unchanged / Improved / Deteriorated
...
| Instance (memory) | `investment-intelligence-hub/memory/weekly_reviews/2026-07-25.md` |
| Optional digest copy | `reports/digest/2026-07-25_weekly_thesis.md` |
